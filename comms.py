...
#The prng we used is called HC-256
#The prng is changed a bit from its original design
...
#There are 6 different calculation used in this prng called: bitrotation, f1, f2, g1, g2, h1, h2
#the length of the output can be detemined
def HC_256(string):
    #In our design, it takes 512 bits input and produce 96 bytes output string
    #This prng needs to create a P table and Q table, both tables cotains 1024 4-bytes number
    ...
    #Fill in W table which there are 2559 4bytes number in it
    ...
    #Using a for loop of 4096 time, which each element in the Q and P table is modified twice which makes it more random
...
#bitrotation operation which is x >>> n, and it equals to x>>n ^ x<<(32-n)
